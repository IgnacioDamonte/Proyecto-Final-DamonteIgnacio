...
def teclado_list(request):
    ...
    return render(request, 'myapp1/teclado_list.html', {'teclados': teclados})
...
def teclado_detail(request, pk):
    ...
    return render(request, 'myapp1/teclado_detail.html', {'teclado': teclado})
...
def teclado_create(request):
    if request.method == "POST":
        ...
        form = TecladoForm()
    return render(request, 'myapp1/teclado_form.html', {'form': form, 'title': 'Crear Teclado'})
...
def teclado_update(request, pk):
    ...
    return render(request, 'myapp1/teclado_form.html', {'form': form, 'title': 'Actualizar Teclado'})
...
def teclado_delete(request, pk):
    ...
    if request.method == "POST":
        teclado.delete()
        return redirect('teclado_list')
    return render(request, 'myapp1/teclado_confirm_delete.html', {'teclado': teclado})

# Vistas para Mouse
@login_required
def mouse_list(request):
    mouses = Mouse.objects.all()
    return render(request, 'myapp1/mouse_list.html', {'mouses': mouses})
...
def mouse_detail(request, pk):
    ...
    return render(request, 'myapp1/mouse_detail.html', {'mouse': mouse})
...
def mouse_create(request):
    if request.method == "POST":
        ...
        form = MouseForm()
    return render(request, 'myapp1/mouse_form.html', {'form': form, 'title': 'Crear Mouse'})
...
def mouse_update(request, pk):
    ...
    return render(request, 'myapp1/mouse_form.html', {'form': form, 'title': 'Actualizar Mouse'})
...
def mouse_delete(request, pk):
    ...
    if request.method == "POST":
        mouse.delete()
        return redirect('mouse_list')
    return render(request, 'myapp1/mouse_confirm_delete.html', {'mouse': mouse})

# Vistas para Auricular
@login_required
def auricular_list(request):
    auriculares = Auricular.objects.all()
    return render(request, 'myapp1/auricular_list.html', {'auriculares': auriculares})
...
def auricular_detail(request, pk):
    ...
    return render(request, 'myapp1/auricular_detail.html', {'auricular': auricular})
...
def auricular_create(request):
    if request.method == "POST":
        ...
        form = AuricularForm()
    return render(request, 'myapp1/auricular_form.html', {'form': form, 'title': 'Crear Auricular'})
...
def auricular_update(request, pk):
    ...
    return render(request, 'myapp1/auricular_form.html', {'form': form, 'title': 'Actualizar Auricular'})
...
def auricular_delete(request, pk):
    ...
    if request.method == "POST":
        auricular.delete()
        return redirect('auricular_list')
    return render(request, 'myapp1/auricular_confirm_delete.html', {'auricular': auricular})

# Vistas para Mousepad
@login_required
def mousepad_list(request):
    mousepads = Mousepad.objects.all()
    return render(request, 'myapp1/mousepad_list.html', {'mousepad': mousepads})
...
def mousepad_detail(request, pk):
    ...
    return render(request, 'myapp1/mousepad_detail.html', {'mousepad': mousepad})
...
def mousepad_create(request):
    if request.method == "POST":
        ...
        form = MousepadForm()
    return render(request, 'myapp1/mousepad_form.html', {'form': form, 'title': 'Crear Mousepad'})
...
def mousepad_update(request, pk):
    ...
    return render(request, 'myapp1/mousepad_form.html', {'form': form, 'title': 'Actualizar Mousepad'})
...
def mousepad_delete(request, pk):
    ...
    if request.method == "POST":
        mousepad.delete()
        return redirect('mousepad_list')
    return render(request, 'myapp1/mousepad_confirm_delete.html', {'mousepad': mousepad})
